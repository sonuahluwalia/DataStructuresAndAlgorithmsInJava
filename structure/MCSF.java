...
public class MCSF {
    public static void main(String[] args)
    {
        ...
        while (!s.eof()) {
            ...
            Integer weight = new Integer(s.readInt());
            s.skipWhite();
            g.add(here);
            g.add(there);
    ...
    //       a minimum spanning forest
    {
        ...
        while (ei.hasNext())
        {
            q.add(new ComparableEdge((Edge)ei.next()));
        }
