...
public class Timing
{
    ...
    final static int lowDur=50000; // in nanoseconds
    final static int highDur=500000; // in nanonseconds
    ...
    public static void speed2()
    {
        ...
        for (trial = 0; trial < 10; trial++)
        {
            ...
            speed = duration/(double)loops - loopSpeed;
