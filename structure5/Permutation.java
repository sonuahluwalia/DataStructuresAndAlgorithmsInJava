 ...
 * on the next pass.
 */
public class Permutation<T> extends AbstractIterator<Vector<T>>
{
    protected Vector<T> original;       // reference to original vector
    protected int size;         // size of original vector
    protected Vector<T> current;        // reference to current permutation
    ...
    public static void main(String args[]) // testing code
    {
        ...
        Permutation<String> p = new Permutation<String>(seq);
        while (p.hasNext())
        {
